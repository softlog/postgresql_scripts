...
CREATE OR REPLACE FUNCTION public.f_py_get_cmd_bloco_nfe(p_xml text)
  RETURNS text AS
$BODY$
    ...
    def ret_produtos(oDom):
        ...
        for produto in listaProdutosXml:
            ...
            l.append(retorna_col('qtd',produto.findAll('qcom'),'numeric(12,6)','','0.00'))
            l.append(retorna_col('unit',produto.findAll('vuncom'),'numeric(12,6)','','0.00'))
            l.append(retorna_col('total',produto.findAll('vprod'),'numeric(12,2)','','0.00'))
            ...
            l_icms = produto.findAll('icms')

            if len(l_icms) > 0:
                icms = l_icms[0]
                l.append(retorna_col('cst',icms.findAll('vazio'),'character(4)','040'))
                ...
                l.append(retorna_col('cst',[],'character(4)',''))
                l.append(retorna_col('bc',[],'numeric(12,2)','','0.00'))
                l.append(retorna_col('aliq_icms',[],'numeric(8,2)','','0.00'))
                l.append(retorna_col('icms',[],'numeric(12,2)','','0.00'))
                l.append(retorna_col('bcst',[],'numeric(12,2)','','0.00'))
                l.append(retorna_col('aliq_icmsst',[],'numeric(12,2)','','0.00'))
                l.append(retorna_col('icmsst',[],'numeric(12,2)','','0.00'))
    ...
    def ret_destinatario(oDom):
        ...
        l.append(retorna_col('bairro',Dest.findAll('xbairro'),'character(40)'))
        l.append(retorna_col('cidade',Dest.findAll('xmun'),'character(60)'))
    ...
    def ret_dados_nfe(oDom):
        ...
        l.append(retorna_col('indpag',ide.findAll('indpag'),'character(1)'))
        ...
        l.append(retorna_col('mod_frete',totais.findAll('mod_frete'),'character(1)','','0'))

        #veiculos = oDom.findAll('veictransp')[0]
        #l.append(retorna_col('placa',veiculos.findAll('placa'),'character(7)'))
        #l.append(retorna_col('uf_veiculo',veiculos.findAll('uf'),'character(2)'))
           


        bloco_aux = oDom.findAll('infprot')[0]
        l.append(retorna_col('chave_nfe',bloco_aux.findAll('chnfe'),'character(44)'))
