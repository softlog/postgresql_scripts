-- Versao com Alteracao Densidade
	...
	-- 			"10"	 0	 0	 1	 1
		...
		SELECT 
			...
			CASE	WHEN ptf.id_tipo_calculo IN (15,19,20,21,22,23,53,74) AND calcular_a_partir_de = 2 THEN total_nf
				...
				WHEN ptf.id_tipo_calculo IN (4,17,18,41,42,43,44,48,49,50,52,54,55,70,71) THEN 1 -- Sem par�metro, ent�o 1 por padr�o 
			...
			CASE	WHEN ptf.medida_inicial = 0 AND ptf.medida_final = 0 	THEN 
				...
				WHEN 	ptf.medida_final = 0 THEN
					CASE	WHEN ptf.id_tipo_calculo IN (15,19,20,21,22,23,74) THEN ptf.total_nf >= ptf.medida_inicial
						...
						WHEN ptf.id_tipo_calculo IN (4,17,18,41,42,43,44,48,49,50,52,70,71,77,78) THEN true -- Sem par�metro, ent�o 1 por padr�o 
					END 
