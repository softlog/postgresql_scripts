...
CREATE OR REPLACE VIEW public.v_notfis_nfe_313_v31 AS 
 SELECT nf.id_nota_fiscal_imp AS id_registro,
	...
	|| btrim(to_char(CASE WHEN r.id_transportador_redespacho = 1102 THEN 0.01 ELSE nf.valor END, '0000000000000V99'::text))) 
   ...
   FROM scr_notas_fiscais_imp nf
     ...
     LEFT JOIN scr_romaneios r ON rnf.id_romaneio = r.id_romaneio;
