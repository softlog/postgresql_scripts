...
CREATE OR REPLACE VIEW public.v_com_compras_mgr AS 
 ...
 SELECT DISTINCT ON (com_compras.numero_compra, com_compras.vl_total) com_compras.id_compra,
    ...
    (( SELECT string_agg(com_compras_itens.placa_veiculo, ',') AS placas_itens
           FROM com_compras_itens
          WHERE com_compras_itens.id_compra = com_compras.id_compra))::text AS placas_itens
   FROM com_compras
...
ALTER TABLE public.v_com_compras_mgr
