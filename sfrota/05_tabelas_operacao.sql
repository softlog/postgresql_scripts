/*
    ...
    Atualizado por Itamar, 20200504
*/
...
(
	...
	CONSTRAINT frt_operacao_diaria_id PRIMARY KEY (id)	
);


COMMENT ON COLUMN frt_operacao_diaria.id
		IS 'Chave primaria';
...
(
	...
	CONSTRAINT frt_tipo_atividades_id PRIMARY KEY (id)	
);


COMMENT ON COLUMN frt_tipo_atividades.id
		IS 'Chave Primaria';
...
(
	...
	CONSTRAINT frt_atividades_id_pk PRIMARY KEY (id),
	CONSTRAINT ind_frt_operacao_diaria_id_operacao_diaria_fk FOREIGN KEY (id_operacao_diaria)
		REFERENCES frt_operacao_diaria (id) MATCH SIMPLE
			ON UPDATE CASCADE ON DELETE CASCADE,
	CONSTRAINT ind_frt_operacao_diaria_placa_veiculo_fk FOREIGN KEY (placa_veiculo)
		REFERENCES veiculos (placa_veiculo) MATCH SIMPLE
			ON UPDATE RESTRICT ON DELETE RESTRICT,
	CONSTRAINT ind_frt_operacao_diaria_id_atividade_fk FOREIGN KEY (id_atividade)
		REFERENCES frt_tipo_atividades (id) MATCH SIMPLE
			ON UPDATE RESTRICT ON DELETE RESTRICT,
	CONSTRAINT ind_frt_operacao_diaria_id_produto_fk FOREIGN KEY (id_produto)
		REFERENCES com_produtos (id_produto) MATCH SIMPLE
			ON UPDATE RESTRICT ON DELETE RESTRICT,
	CONSTRAINT ind_frt_operacao_diaria_id_filial_sub_fk FOREIGN KEY (id_filial_sub)
		REFERENCES filial_sub (id_filial_sub) MATCH SIMPLE
			ON UPDATE RESTRICT ON DELETE RESTRICT,
	CONSTRAINT ind_frt_operacao_diaria_id_operador_sub_fk FOREIGN KEY (id_operador)
...
COMMENT ON COLUMN frt_atividades.id
		IS 'Chave Primaria';
...
(
	...
	CONSTRAINT frt_tipo_inspecao_id PRIMARY KEY (id)	
);	

COMMENT ON COLUMN frt_tipo_inspecao.id
...
INSERT INTO frt_tipo_inspecao (id, tipo_inspecao)
VALUES (1, 'Detalhes de Inspecao por Maquina');

INSERT INTO frt_tipo_inspecao (id, tipo_inspecao)
VALUES (2, 'Detalhes de Inspecao por Maquina');
...
(
	...
	CONSTRAINT frt_tipo_inspecao_itens_id PRIMARY KEY (id),	
	CONSTRAINT ind_frt_operacao_diaria_id_tipo_inspecao_fk FOREIGN KEY (id_tipo_inspecao)
		REFERENCES frt_tipo_inspecao (id) MATCH SIMPLE
			ON UPDATE CASCADE ON DELETE CASCADE
	
);	

COMMENT ON COLUMN frt_tipo_inspecao_itens.id
		IS 'Chave Primaria';
...
(
	...
	CONSTRAINT frt_operacao_diaria_inspecao_id_pk PRIMARY KEY (id),
	CONSTRAINT ind_frt_operacao_diaria_inspecao_id_operacao_diaria_fk FOREIGN KEY (id_operacao_diaria)
		REFERENCES frt_operacao_diaria (id) MATCH SIMPLE
			ON UPDATE CASCADE ON DELETE CASCADE,		
	CONSTRAINT ind_frt_operacao_diaria_inspecao_id_tipo_inspecao_item_fk FOREIGN KEY (id_tipo_inspecao_item)
		REFERENCES frt_tipo_inspecao_itens (id) MATCH SIMPLE
			ON UPDATE RESTRICT ON DELETE RESTRICT	
			
);

COMMENT ON COLUMN frt_operacao_diaria_inspecao.id
		IS 'Chave Primaria';
